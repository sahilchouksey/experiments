"""
Parakeet v3 STT engine — /ws/parakeet-v3

NVIDIA NeMo `nvidia/parakeet-tdt-0.6b-v3` (multilingual) with
Silero VAD chunking for real-time transcription.
"""
...
@register("parakeet-v3")
class ParakeetV3Engine(STTEngine):
    def mount(self, app: FastAPI) -> None:
        @app.websocket("/ws/parakeet-v3")
        async def ws_parakeet_v3(websocket: WebSocket):
